...
Traefik can be configured to use Azure Service Fabric as a backend configuration.
...
| `traefik.backend.group.name`                               | Group all services with the same name into a single backend in Traefik                                                                                                                                                     |
